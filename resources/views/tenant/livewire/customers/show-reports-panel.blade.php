    ...
    <div class="row">
        <div class="col">
            <div class="card" style="border-top-left-radius: 0px; border-top-right-radius: 0px;">
                <div class="card-header" style="padding:1!important">
                    <div class="col-12 text-right pr-0">
                        <div class="row">
                            <div class="col-12">                                
                                <label class="font-weight-bold">{{ __('Hours in this client')}}:&nbsp;</label>{{ global_hours_sum($reportsFromClient) }}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                    <div class="table-responsive" wire:key="tenantteammembersshow" style="padding: 1.875rem;">
                        ...
                        <table id="dataTables-data" class="table table-responsive-lg mb-0 table-striped">
                            ...
                            <tbody>
                                @foreach($reportsFromClient as $item)
                                    <tr>
                                        <td>
                                            <div class="custom-control custom-checkbox">
