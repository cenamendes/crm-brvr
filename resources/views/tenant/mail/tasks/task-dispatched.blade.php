                                    ...
                                    <tr>
                                        <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                            ...
                                            <div class="table" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                    ...
                                                    <p style="font-family: Avenir, Helvetica, sans-serif; color: #74787e; ">
                                                        <b>{{__("Location")}}: </b> {{$task->taskLocation->description}}
                                                    </p>
                                                    <p style="font-family: Avenir, Helvetica, sans-serif; color:#74787e;">
                                                        <b>{{__("Address")}}: </b> {{$task->taskLocation->address}}
                                                    </p>
                                                    <p style="font-family: Avenir, Helvetica, sans-serif; color: #74787e; ">
                                                        <b>{{__("County")}}: </b> {{$task->taskLocation->locationCounty->name}}
                                                    </p>
                                                    <p style="font-family: Avenir, Helvetica, sans-serif; color: #74787e; ">
                                                        <b>{{__("District")}}: </b> {{$task->taskLocation->locationDistrict->name}}
                                                    </p>
                                                    <p style="font-family: Avenir, Helvetica, sans-serif; color: #74787e; ">
                                                        <b>{{__("Scheduled Date")}}: </b> {{$task->scheduled_date}}
                                                    </p>
                                                    <p style="font-family: Avenir, Helvetica, sans-serif; color: #74787e; ">
                                                        <b>{{__("Scheduled Hour")}}: </b> {{$task->scheduled_hour}}
                                                    </p>
                                                    <p style="font-family: Avenir, Helvetica, sans-serif; color: #74787e; ">
