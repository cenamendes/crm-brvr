                                    ...
                                    <tr>
                                        <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                            ...
                                            <div class="table" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                   <p>{{__("Thank you for registering the member")}}</p>
                                                   <p style="text-align:center;">{{ __("Name")}}</p>
                                                   <p style="text-align:center;font-weight:bold;">{{$teamMember->name}}</p>
                                                   <p style="text-align:center;">{{ __("Username")}}</p>
                                                   <p style="text-align:center;font-weight:bold;">{{$teamMember->username}}</p>
                                                   <p style="text-align:center;">{{ __("Password of access") }}</p>
                                                   <p style="text-align:center;font-weight:bold">{{$teamMemberPassword["password_without_hashed"]}}</p>
                                            </div>
                                            <hr>
