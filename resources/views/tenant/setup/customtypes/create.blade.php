<x-tenant-layout title="{{ __('Create Custom Type') }}" :themeAction="$themeAction">
    <div class="container-fluid">
        ...
        <!-- row -->
        <x-tenant.setup.customtypes.form :action="route('tenant.setup.custom-types.store')" :update="false" buttonAction="{{ __('Create Custom Type') }}" formTitle="{{ __('Create Custom Type') }}"/>
    </div>
    <div class="erros">
        @if ($errors->any())
