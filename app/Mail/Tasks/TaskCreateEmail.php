...
class TaskCreateEmail extends Mailable
{
    ...
    {
          //env('MAIL_USERNAME')
        $subject = 'Tarefa #' . $this->task->reference . ' criada com sucesso.';
        return new Envelope(
            subject: $subject,
    ...
    public function build()
    {
        ...
        $email = $this
            ->view('tenant.mail.tasks.task-created',[
                "subject" => $subject,
                "task" => $this->task,
